        ...
        <div className='grid w-full grid-cols-2 gap-16 md:grid-cols-1'>
          <div className='flex flex-col items-start justify-center md:order-2'>
            ...
            <p className='font-medium'>
              I&lsquo;m a Frontend Developer with 1 year of experience in Web
              Development, working with technologies like ReactJS/NextJS.
            </p>
            <p className='py-4 font-medium'>
              With an understanding of UI/UX, I enjoy solving Frontend issues
              and applying new technologies as well as my experience to projects
